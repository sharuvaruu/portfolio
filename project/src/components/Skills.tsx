...
const skills = {
  "Programming Languages": {
    ...
    items: ["C++", "Java", "C", "Python", "JavaScript"]
  },
  "AI/ML & Data": {
    icon: <Brain className="h-6 w-6 text-indigo-500" />,
    items: ["TensorFlow", "Scikit-learn", "Data Visualization", "Big Data Analytics"]
  },
  "Web Development": {
    icon: <Terminal className="h-6 w-6 text-pink-500" />,
    items: ["React", "Flask", "HTML/CSS", "MongoDB"]
  },
  "Tools & Platforms": {
    icon: <Wrench className="h-6 w-6 text-green-500" />,
    items: ["Git", "GitHub", "Postman", "Heroku", "Railway", "Linux"]
  },
  "Core Subjects": {
    icon: <BookOpen className="h-6 w-6 text-blue-500" />,
    items: ["Data Structures", "DBMS", "OOPs", "OS", "Project Management"]
  },
  "Soft Skills": {
    icon: <Database className="h-6 w-6 text-orange-500" />,
    items: ["Leadership", "Communication", "Content Writing", "Documentation", "Teamwork"]
  }
};
