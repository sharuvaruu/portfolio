      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="mb-8 flex justify-center">
          <div className="relative">
            ...
            <img 
              src="https://avatars.githubusercontent.com/u/98325693?v=4"
              alt="Sharvari Salodkar" 
        ...
        <div className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-sm px-6 py-3 rounded-full shadow-md mb-8 hover:shadow-lg transition-all">
          ...
          <span className="text-gray-700 font-medium">Currently working on CLIR</span>
        </div>
        ...
        <p className="text-xl md:text-2xl text-gray-700 mb-8 animate-fade-in-delay">
          AI/ML Enthusiast | Final Year IT Student at SGGSIE&T
        </p>
        <p className="text-lg text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxed">
          Passionate about leveraging AI/ML for innovative solutions. 
          Currently focused on Cross-Lingual Information Retrieval and Investment Analysis.
        </p>
