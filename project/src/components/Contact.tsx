...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:sharvarisalodkar@gmail.com?subject=Portfolio Contact from ${encodeURIComponent(name)}&body=${encodeURIComponent(
      `From: ${name}\nEmail: ${email}\n\nMessage:\n${message}`
    )}`;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-gray-600 mb-12 text-center text-lg">
            I'm always excited to collaborate on AI/ML projects and connect with fellow tech enthusiasts.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a
              href="https://www.linkedin.com/in/sharvari-salodkar-587b611a5"
              target="_blank"
            ...
            <a
              href="https://github.com/sharuvaruu"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
            >
